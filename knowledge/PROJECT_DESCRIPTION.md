...
**Probabimals** is a round-based strategy game centered around building probabilistic machines and leveraging their outcomes in combat.
...
2. **Build crafting** — the depth comes from discovering synergies between parts and optimizing machine configurations.
