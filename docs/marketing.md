...
```mermaid
graph TD
    Everyone["Everyone"] --> Gamers["Gamers"]
    Gamers --> StrategyFans["Strategy / Puzzle Game Fans"]
    StrategyFans --> DiceFans["Dice & Tabletop Enthusiasts"]
    DiceFans --> RoguelikeFans["Roguelike Deckbuilder Fans"]
    RoguelikeFans --> CoreAudience["Core Audience:\nProbability-as-Strategy Players"]
```
