...
static func face(
	id: String,
	value: int,
	face_type: DiceFace.Type = DiceFace.Type.BASIC,
...
static func die_from_values(
	values: Array, die_color: String = "colorless", die_name: String = "Test Die", description: String = "Test die"
) -> Die:
...
static func deterministic_die(
	roll_values: Array[int],
	initial_values: Variant = null,
	die_color: String = "colorless",
	die_name: String = "Test Die",
	description: String = "Deterministic test die"
) -> Die:
...
static func modifier(
	effect: String, value: Variant, condition: String = "always", id: String = "", name: String = ""
) -> Modifier:
